...
@Slf4j
@Component
public class CwQuery extends PluginSemanticQuery {
    ...
    public QueryResult execute(User user) {
        ...
        QuerySqlReq querySqlReq = QueryReqBuilder.buildPureSqlReq(cwResp.getCorrectorSql(), parseInfo.getModelId(), cwResp.getSqlSourceId());
