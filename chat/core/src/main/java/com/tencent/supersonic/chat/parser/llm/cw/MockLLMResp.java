...
public class MockLLMResp {
    ...
    public static Map<String, CwResp> queryMap = ImmutableMap.of(
            query1.getOriginQueryText(), query1,
            query2.getOriginQueryText(), query2,
            query3.getOriginQueryText(), query3,
            query4.getOriginQueryText(), query4,
            query5.getOriginQueryText(), query5
    );
