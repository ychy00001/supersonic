...
from utils.api_response import return_msg, ret_error, ret_success
...
async def dim_val_similarity_search(query_text_list: List[str], query_filter: Optional[Dict[str, str]] = None,
                                    n_results: int = 1):
    '''
    Args:
