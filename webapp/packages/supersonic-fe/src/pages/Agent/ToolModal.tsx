  ...
  return (
    ...
    >
      <Form {...layout} form={form}>
        ...
        {(toolType === AgentToolTypeEnum.RULE || toolType === AgentToolTypeEnum.DSL || toolType === AgentToolTypeEnum.CW) && (
        ...
        {(toolType === AgentToolTypeEnum.DSL || toolType === AgentToolTypeEnum.CW) && (
