  ...
  return (
    ...
    >
      <Form {...layout} form={form}>
        ...
        {(toolType === AgentToolTypeEnum.RULE || toolType === AgentToolTypeEnum.LLM_S2QL || toolType === AgentToolTypeEnum.CW) && (
        ...
        {(toolType === AgentToolTypeEnum.LLM_S2QL || toolType === AgentToolTypeEnum.CW) && (
